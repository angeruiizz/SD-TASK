...
# Asegúrate de poder importar desde otra carpeta
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'XMLRPC', 'InsultServer')))
from consumer import InsultServer
