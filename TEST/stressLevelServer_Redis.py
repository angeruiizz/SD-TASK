...
num_producers = int(input("¿Cuántos producers tienes corriendo? (normalmente 1): "))
input("Lanza observable.py y los producer.py en otras terminales y pulsa Enter aquí para continuar...")
...
while client.scard(INSULT_SET) < min(N, len(INSULTS)):
    time.sleep(0.1)
