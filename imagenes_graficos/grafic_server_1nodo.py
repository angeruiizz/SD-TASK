...
# Filtrar solo los datos con workers = 1 y quitamos XMLRPC
df1 = df[(df['workers'] == 1) & (df['sistema'] != 'XMLRPC')]
...
plt.title('Requests per Second vs. Número de Peticiones (servidor=1)')
...
plt.title('Tiempo Total vs. Número de Peticiones (servidor=1)')
plt.xlabel('Número de Peticiones')
...
plt.title('Tiempo Medio por Petición vs. Número de Peticiones (servidor=1)')
plt.xlabel('Número de Peticiones')
